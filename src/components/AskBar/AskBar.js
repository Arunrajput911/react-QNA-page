        ...
        <div className="modal-content">
            ...
            <div className="modal-body">
                <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <div className="form-group">
                        <textarea className="form-control" id="ques-tags" rows="2" placeholder="Add tags (optional)"
                        value={tags}
